...
const RESULTS = [
  {
    level:   'green',
    icon:    `<svg viewBox="0 0 32 32" fill="none" width="32" height="32"><circle cx="16" cy="16" r="14" stroke="currentColor" stroke-width="1.8"/><path d="M10 16l4 4 8-8" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
    tag:     'Tu salud dental',
  ...
  {
    level:   'yellow',
    icon:    `<svg viewBox="0 0 32 32" fill="none" width="32" height="32"><circle cx="16" cy="16" r="14" stroke="currentColor" stroke-width="1.8"/><path d="M16 10v7" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/><circle cx="16" cy="21.5" r="1.2" fill="currentColor"/></svg>`,
  ...
  {
    level:   'red',
    icon:    `<svg viewBox="0 0 32 32" fill="none" width="32" height="32"><path d="M16 4L30 28H2L16 4z" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round"/><path d="M16 14v6" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/><circle cx="16" cy="23.5" r="1.2" fill="currentColor"/></svg>`,
...
function renderQuestion(index) {
  ...
  quizBody.innerHTML = `
    ...
    <div class="quiz__choices">
      <button class="quiz__btn quiz__btn--yes" onclick="answer(true, ${index})">${BTN_YES[index]}</button>
      <button class="quiz__btn quiz__btn--no"  onclick="answer(false, ${index})">${BTN_NO[index]}</button>
    </div>
  `;
}
